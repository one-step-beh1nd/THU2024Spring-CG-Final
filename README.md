# THU 2024 春 计算机图形学基础大作业（42.5分/45分，未完结，欢迎补充纠错）

- [THU 2024 春 计算机图形学基础大作业（42.5分/45分，未完结，欢迎补充纠错）](#thu-2024-春-计算机图形学基础大作业425分45分未完结欢迎补充纠错)
  - [说在前面](#说在前面)
  - [致谢与参考](#致谢与参考)
  - [一、 效果图](#一-效果图)
    - [路径追踪：](#路径追踪)
...
我们将光线的方向向量记为D，光线的源点记为O，光线交点的参数为tr(ray.origin + tr * ray.direction是交点)
